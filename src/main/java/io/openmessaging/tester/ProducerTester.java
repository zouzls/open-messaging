...
public class ProducerTester {
        ...
        public void run() {
            while (true) {
                try {
                    ...
                    String body=label + "_" + offsets.get(queueOrTopic);
                    Message message = producer.createBytesMessageToQueue(queueOrTopic, body.getBytes());
                    //message.putHeaders("header_"+sendNum,"value_"+sendNum);
    ...
    public static void main(String[] args) throws Exception {
        ...
        logger.info("Produce Finished, Cost {} ms tps:{} q/ms", end - start,Constants.PRO_MAX/(end-start));
    }
}
